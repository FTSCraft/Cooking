...
public enum CookingItem {
    ...
    //Default food
    COOKED_COD(CookingDeviceType.COOKING_POT, 5),
    COOKED_SALMON(CookingDeviceType.COOKING_POT, 5),
    COOKED_PORKCHOP(CookingDeviceType.COOKING_POT, 5),
    COOKED_BEEF(CookingDeviceType.COOKING_POT, 5),
    COOKED_CHICKEN(CookingDeviceType.COOKING_POT, 5),
    COOKED_MUTTON(CookingDeviceType.COOKING_POT, 5),
    COOKED_RABBIT(CookingDeviceType.COOKING_POT, 5),
